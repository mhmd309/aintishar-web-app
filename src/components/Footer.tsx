...
const socialLinks: (SocialLink & { className: string })[] = [
  { name: 'فيسبوك', url: 'https://www.facebook.com/aintishar2/', icon: 'facebook', className: 'footer-social-facebook' },
  { name: 'واتساب', url: 'https://wa.me/+201024704900', icon: 'whatsapp', className: 'footer-social-whatsapp' },
  { name: 'إنستجرام', url: 'https://www.instagram.com/aintishar2/', icon: 'instagram', className: 'footer-social-instagram' },
  { name: 'يوتيوب', url: 'https://www.youtube.com/@aintishar2', icon: 'youtube', className: 'footer-social-youtube' },
];
...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-[#030812] via-[#071326] to-[#10233e]">
          ...
          <div className="lg:col-span-5">
            <div className="flex items-start justify-start gap-2">
              ...
              <div className="text-right">
                <h2 className="text-lg font-bold text-white">إنتشار للبرمجيات</h2>
                <p className="text-sm text-gray-400">والتسويق الإلكتروني</p>
              </div>
            </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-3">
              <a href={`mailto:${COMPANY.email}`} className="footer-contact-item group">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-primary-500/20 text-primary-400">
